...
## 2. Конфигурация Suricata (af-packet)
  ...
  Первоначально рекомендую запускать в тестовом режиме для проверки коррекности сборки:
  
  ```bash
  sudo suricata -T -c /etc/suricata/suricata.yaml
  ```

  Запустите Suricata с помощью вашего конфигурационного файла в интерактивном режиме:
